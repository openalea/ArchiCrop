...
class ArchiCrop:
    ...
    def __init__(self, 
        ...
        :param skew: float, parameter describing the asymmetry of the bell-shaped distribution of leaf lengths along the stem
