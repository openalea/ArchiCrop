...
archi_maize = {
    ...
    # N demand
    "SLA": 300, # Specific Leaf Area (cm2/g)
    "N_conc_leaf": 0.048, # Nitrogen concentration in leaves (g N/g DM)
}
...
archi_wheat = {
    ...
    "nb_phy": 9, # number of phytomers on the main stem 
    "nb_short_phy": 5,
    "short_phy_len": 1,
    ...
    # Leaf area distribution along the stem
    "leaf_area": 1500,
    "rmax": [0.7,1.0], # 0.83, # parameter for leaf area distribution along axis 
    ...
    # Development
    "phyllochron": 44, # [30,70], # phyllochron, i.e. stem element appearance rate 
    # "plastochron": [40,65], # plastochron, i.e. leaf blade appearance rate 
    "stem_duration": 1.6,
    "leaf_duration": 1.6,

    # Tillering
    "nb_tillers": 2, # number of tillers 
    "tiller_angle": 5,
    "tiller_delay": 1, # delay, as factor of phyllochron, between the appearance of a phytomer and the appearance of its tiller 
    "reduction_factor": 1, # reduction factor between tillers of consecutive order 
    ...
    # N demand
    "SLA": 200, # Specific Leaf Area (cm2/g)
    "N_conc_leaf": 0.0647, # Nitrogen concentration in leaves (g N/g DM)
    }
...
archi_rice = {
    ...
    "nb_phy": 8, # number of phytomers on the main stem 
    "nb_short_phy": 5,
    "short_phy_len": 3,
    ...
    "height": 110,
    "stem_q": 1, # parameter for ligule height distribution along axis 
    "diam_base": 1.0, # stem base diameter 
    "diam_top": 0.5, # stem top diameter

    # Leaf area distribution along the stem
    "leaf_area": 3000,
    "rmax": [0.5,1.0], # 0.78, # parameter for leaf area distribution along axis 
    "skew": [-10,0], # parameter for leaf area distribution along axis 
    
    # blade area 
    "wl": 0.03, # leaf blade width-to-length ratio 
    "klig": 0.6, # parameter for leaf blade shape
    "swmax": 0.55, # parameter for leaf blade shape
    "f1": 0.64, # parameter for leaf blade shape
    "f2": 0.92, # parameter for leaf blade shape
    ...
    # Leaf blade position in space
    "insertion_angle": 20, # leaf blade insertion angle 
    "scurv": 0.6, # leaf blade relative inflexion point 
    "curvature": 20, # leaf blade insertion-to-tip angle 
    "phyllotactic_angle": 180, # phyllotactic angle 
    "phyllotactic_deviation": 90, # half-deviation to phyllotactic angle 

    # Development
    "phyllochron": 60, # [30,70], # phyllochron, i.e. stem element appearance rate
    # "plastochron": [40,65], # plastochron, i.e. leaf blade appearance rate 
    "stem_duration": 1.6,
    "leaf_duration": 1.6,
    ...
    "tiller_angle": 15,
    "tiller_delay": 1, # delay, as factor of phyllochron, between the appearance of a phytomer and the appearance of its tiller 
    "reduction_factor": 0.93, # reduction factor between tillers of consecutive order 
    "tropism_coefficient": 0.12
}
...
archi_sorghum = {
    ...
    # N demand
    "SLA": 160, # Specific Leaf Area (cm2/g)
    "N_conc_leaf": 0.048, # Nitrogen concentration in leaves (g N/g DM)
}
