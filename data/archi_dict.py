...
archi_maize = {
    "nb_phy": 20, # number of phytomers on the main stem
    "nb_short_phy": 4,
    "short_phy_height": 3,
    ...
    # blade area
    "wl": 0.15, # leaf blade width-to-length ratio 
...
archi_wheat = {
    ...
    "scurv": 0.8, # leaf blade relative inflexion point : [0.6, 0.8] ()
...
archi_rice = {
    ...
    # blade area 
    "wl": 0.05, # leaf blade width-to-length ratio : [0.1, 0.12] ()
    "klig": 0.6, # parameter for leaf blade shape
    "swmax": 0.55, # parameter for leaf blade shape
    "f1": 0.64, # parameter for leaf blade shape
    "f2": 0.92, # parameter for leaf blade shape
    ...
    "curvature": 30, # leaf blade insertion-to-tip angle : [0,130] [45, 135] (Kaitaniemi et al., 1999)
    "phyllotactic_angle": 137.5, # phyllotactic angle : [180] (Davis et al., 2024)
    "phyllotactic_deviation": 0, # half-deviation to phyllotactic angle : [0,90] (Davis et al., 2024)
...
archi_sorghum = {
    "nb_phy": 17, # number of phytomers on the main stem : [10,40] (Ndiaye et al., 2021; Lafarge and Tardieu, 2002; Clerget, 2008; Ganeme et al., 2022)
    "nb_short_phy": 4,
    "short_phy_height": 3,
    ...
    "height": 200,
    "stem_q": 1, # parameter for ligule height distribution along axis : [1.1] (Kaitaniemi et al., 1999) 
    "diam_base": 3.0, # stem base diameter : [2.2] (Ndiaye et al., 2021)
    ...
    # blade area 
    "wl": 0.13, # leaf blade width-to-length ratio : [0.1, 0.12] ()
    "klig": 0.6, # parameter for leaf blade shape
    "swmax": 0.55, # parameter for leaf blade shape
    "f1": 0.64, # parameter for leaf blade shape
    "f2": 0.92, # parameter for leaf blade shape
...
archi_sorghum_angles = {
    "nb_phy": 20, # [10,30], # number of phytomers on the main stem : [10,40] (Ndiaye et al., 2021; Lafarge and Tardieu, 2002; Clerget, 2008; Ganeme et al., 2022)
    "nb_short_phy": 4,
    "short_phy_height": 3,
    ...
    # Leaf blade position in space
    "insertion_angle": [30,45,60], # [15,30,45,60,75,90], # leaf blade insertion angle : [10,80] (Truong et al., 2015; Kaitaniemi et al., 1999)
